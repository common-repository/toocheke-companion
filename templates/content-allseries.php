    ...
    while ($series_query->have_posts()): $series_query->the_post();
        ...
        if (!$link_to_series) {
            ...
            while ($first_comic_query->have_posts()): $first_comic_query->the_post();
                $series_link = add_query_arg('sid', $series_id, get_post_permalink()); // Display the image of the first post in category
            endwhile;
        }
...
// Reset Post Data
        ...
        ?>
				                    <span class="series-thumbnail-wrapper">
				                        <a class="series-thumbnail" href="<?php echo esc_url($series_link); ?>">
		                                <img
